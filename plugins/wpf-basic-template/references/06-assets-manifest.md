...
- **每月至少巡检一次**：核对 `01-project-layout.md`「包组合」全部包的最新【稳定版】，有新版则同步 `SKILL.md` 索引、`assets/Directory.Packages.props`、`assets/src/__APP_NAME__/__APP_NAME__.csproj`。**更新后无需推送 GitHub**，本地保留即可。
